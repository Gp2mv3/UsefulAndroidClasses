...
public class Network
{
	...
	private boolean DEBUG = true; //If True, show every request and response
	...
	{
		this.url = Const.SERV+Const.SERV_FOLDER+url;
	 ...
	 * @param url the url to the page
	 */
	public Network(String url, boolean post)
	{
		this(url);
		if(!post) this.url = Const.SERV+url;
	}
	...
	private void executeRequest(HttpUriRequest request, String url)
	{
		...
		if(DEBUG) Log.v("network request", request.getURI().toString());
		try
		{
			...
			if(DEBUG) Log.v("network response", response);
